...
- **SECTION_NAME** = [Human-readable name, e.g., "Clients" or "Dashboards"]
- **SECTION_ID** = [Folder name in sections/, e.g., "clients" or "dashboards"]
- **NN** = [Milestone number, e.g., "03" or "06" — sections start at 03 since 01 is Foundation and 02 is Shell]
